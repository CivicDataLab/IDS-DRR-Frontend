...
export type IndicatorsByCategoryQuery = { indicatorsByCategory: Array<{ slug: string, name: string, description: string | null, IDS_dataSpace: string | null, children: Array<{ slug: string, name: string, description: string | null, IDS_dataSpace: string | null, children: Array<{ slug: string, name: string, description: string | null, IDS_dataSpace: string | null }> }> }> };
...
export type GetStatesListQuery = { getStates: Array<{ name: string, slug: string, code: string, center: Array<number> | null, bounds: Array<Array<number>> | null, child_type: string | null, resource_id: string, time_periods: Array<string>, latest_time_period: string | null }> };
